    ...
    <form action="#" method="post" id="dodajForm">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="number" style="border: 1px solid black" name="brojTitula" class="form-control" placeholder="Broj titula *" value="<?php echo $_SESSION['timovi'][$index]['brojTitulaa'] ?>" />
                </div>
                <div class="form-group">
